...
<style>
	...
	#my_table{
    /*margin-top:10px /*moves your table n pixels down*/
    /*margin-left:10px /*moves your table n pixels right*/
    margin-right:30px /*moves your table n pixels left*/
    /*margin-bottom:10px /*moves your table n pixels up*/
}
...
<table attribute id="my_table" style="border=none; border-collapse: collapse;"> 
	<tr>
